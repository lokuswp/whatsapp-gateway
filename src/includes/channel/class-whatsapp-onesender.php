...
class Notification_Whatsapp_OneSender extends Notification\Gateway {
	...
	protected array $docs_url = array(
		'id_ID' => 'https://lokuswp.id/panduan/lokuswp/notifikasi/integrasi/onesender.html',
		'en_US' => 'https://lokuswp.com/guides/lokuswp/notifications/integration/onesender.html',
	);
	...
	public function prepare_data( $notification_obj ) {
		...
		return apply_filters( 'lokuswp/notification/whatsapp/onesender/data', $data, $notification_obj->transaction_id );
	}
	...
	public function templating( $role, $notification_obj ) {
		...
		do_action( 'lokuswp/notification/whatsapp/onesender/after_templating', $notification_obj );
