...
<style>
    /* Action Tab */
    #tab-onesender-log:checked ~ .tab-body-wrapper #tab-body-onesender-log,
    #tab-onesender-settings:checked ~ .tab-body-wrapper #tab-body-onesender-settings {
        position: relative;
        top: 0;
        opacity: 1;
    }
...
<div class="tabs-wrapper">
    <input type="radio" name="onesender" id="tab-onesender-log" checked="checked"/>
    <label class="tab" for="tab-onesender-log"><?php _e( 'Log', 'lokuswp' ); ?></label>

    <input type="radio" name="onesender" id="tab-onesender-settings"/>
    <label class="tab" for="tab-onesender-settings"><?php _e( 'Settings', 'lokuswp' ); ?></label>

    <div class="tab-body-wrapper">

        <!------------ Tab : Test and Log ------------>
        <div id="tab-body-onesender-log" class="tab-body">

            <!--			<div class="divider" data-content="Test Notification"></div>-->
            <!--			<div class="input-group" style="width:50%;">-->
            <!--				<input id="lokuswp_onesender_test" style="margin-top:3px;" class="form-input input-md"-->
            <!--				       type="text" placeholder="0812387621f812">-->
            <!--				<button id="lokuswp_onesender_sendtest" style="margin-top:3px;"-->
        ...
        <!------------ Tab : Settings ------------>
        <div id="tab-body-onesender-settings" class="tab-body">
            ...
            <form class="form-horizontal">
                ...
                <div class="form-group">
                    <div class="col-3 col-sm-12">
                        <label class="form-label" for="apikey"><?php _e( 'API URL', "lokuswp-onesender" ); ?></label>
                    </div>
                ...
                <div class="form-group">
                    <div class="col-3 col-sm-12">
                        <label class="form-label" for="apikey"><?php _e( 'API Key', "lokuswp-onesender" ); ?></label>
                    </div>
                    <div class="col-9 col-sm-12">
...
<script>
    ...
    // jQuery(document).on("click", "#lokuswp_onesender_sendtest", function (e) {
    //     const elTextPhone = jQuery('#lokuswp_onesender_test');
    //     const that = this;
    //
    //     if (elTextPhone.val() !== '') {
    ...
    //             action: 'lokuswp_notification_onesender_test',
