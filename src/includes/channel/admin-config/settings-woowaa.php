...
<style>
    /* Action Tab */
    #tab-wa_gateway-log:checked ~ .tab-body-wrapper #tab-body-wa_gateway-log,
    #tab-wa_gateway-settings:checked ~ .tab-body-wrapper #tab-body-wa_gateway-settings {
        position: relative;
        top: 0;
        opacity: 1;
    }
...
<div class="tabs-wrapper">
    <input type="radio" name="wa_gateway" id="tab-wa_gateway-log" checked="checked"/>
    <label class="tab" for="tab-wa_gateway-log"><?php _e( 'Log', 'lokuswp' ); ?></label>

    <input type="radio" name="wa_gateway" id="tab-wa_gateway-settings"/>
    <label class="tab" for="tab-wa_gateway-settings"><?php _e( 'Settings', 'lokuswp' ); ?></label>

    <div class="tab-body-wrapper">

        <!------------ Tab : Test and Log ------------>
        <div id="tab-body-wa_gateway-log" class="tab-body">

            <!--			<div class="divider" data-content="Test Notification"></div>-->
            <!--			<div class="input-group" style="width:50%;">-->
            <!--				<input id="lokuswp_wa_gateway_test" style="margin-top:3px;" class="form-input input-md"-->
            <!--				       type="text" placeholder="0812387621f812">-->
            <!--				<button id="lokuswp_wa_gateway_sendtest" style="margin-top:3px;"-->
        ...
        <!------------ Tab : Settings ------------>
        <div id="tab-body-wa_gateway-settings" class="tab-body">
            ...
            <form class="form-horizontal">
                ...
                <div class="form-group">
                    <div class="col-3 col-sm-12">
                        <label class="form-label" for="apikey"><?php _e( 'API URL', "lokuswp-wa_gateway" ); ?></label>
                    </div>
                    <div class="col-9 col-sm-12">
                        <input class="form-input" type="text" name="apiurl"
                               placeholder="https://wamd05125.api-wa.my.id/api/v1/messages" style="width:320px"
                               value="<?= $apiurl; ?>">
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="col-3 col-sm-12">
                        <label class="form-label" for="apikey"><?php _e( 'API Key', "lokuswp-wa_gateway" ); ?></label>
                    </div>
                    <div class="col-9 col-sm-12">
                        <input class="form-input" type="password" autocompleted="off" name="apikey"
                               placeholder="dk_67b34e7cd0e25157124d565fe16ac516d" style="width:320px"
                               value="<?= $apikey; ?>">
                    </div>
                </div>
...
<script>
    ...
    // jQuery(document).on("click", "#lokuswp_wa_gateway_sendtest", function (e) {
    //     const elTextPhone = jQuery('#lokuswp_wa_gateway_test');
    //     const that = this;
    //
    //     if (elTextPhone.val() !== '') {
    ...
    //             action: 'lokuswp_notification_wa_gateway_test',
