...
<style>
    /* Action Tab */
    #tab-starsender-log:checked ~ .tab-body-wrapper #tab-body-starsender-log,
    #tab-starsender-settings:checked ~ .tab-body-wrapper #tab-body-starsender-settings {
        position: relative;
        top: 0;
        opacity: 1;
    }
...
<div class="tabs-wrapper">
    <input type="radio" name="starsender" id="tab-starsender-log" checked="checked"/>
    <label class="tab" for="tab-starsender-log"><?php _e( 'Log', 'lokuswp' ); ?></label>

    <input type="radio" name="starsender" id="tab-starsender-settings"/>
    <label class="tab" for="tab-starsender-settings"><?php _e( 'Settings', 'lokuswp' ); ?></label>

    <div class="tab-body-wrapper">

        <!------------ Tab : Test and Log ------------>
        <div id="tab-body-starsender-log" class="tab-body">

            <!--			<div class="divider" data-content="Test Notification"></div>-->
            <!--			<div class="input-group" style="width:50%;">-->
            <!--				<input id="lokuswp_starsender_test" style="margin-top:3px;" class="form-input input-md"-->
            <!--				       type="text" placeholder="0812387621f812">-->
            <!--				<button id="lokuswp_starsender_sendtest" style="margin-top:3px;"-->
        ...
        <!------------ Tab : Settings ------------>
        <div id="tab-body-starsender-settings" class="tab-body">
            ...
            <form class="form-horizontal">
                ...
                <div class="form-group">
                    <div class="col-3 col-sm-12">
                        <label class="form-label" for="apikey"><?php _e( 'API Key', "lokuswp-starsender" ); ?></label>
                    </div>
...
<script>
    ...
    // jQuery(document).on("click", "#lokuswp_starsender_sendtest", function (e) {
    //     const elTextPhone = jQuery('#lokuswp_starsender_test');
    //     const that = this;
    //
    //     if (elTextPhone.val() !== '') {
    ...
    //             action: 'lokuswp_notification_starsender_test',
